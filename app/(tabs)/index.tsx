      ...
      <ScrollView ref={scrollViewRef} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.mainCanvas}>
          ...
          <View style={styles.footerSection}>
            ...
            <Text style={{ fontSize: 10, color: 'gray', textAlign: 'center', marginVertical: 10 }}></Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  searchInputRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 4 },
  searchIcon: { marginRight: 8 },
  searchInput: { flex: 1, fontSize: 14, color: '#1A202C', fontWeight: '600' },
  consoleDivider: { height: 1, backgroundColor: '#EDF2F7', marginVertical: 10, marginHorizontal: 10 },
  consoleActionsRow: {
    flexDirection: 'row', justifyContent: 'space-between',
    paddingHorizontal: 10, marginBottom: 10, alignItems: 'center',
  },
  consoleAction: { flexDirection: 'row', alignItems: 'center', flex: 1, gap: 5 },
  consoleActionText: { color: '#4A5568', fontSize: 13, fontWeight: '600' },
  verticalDivider: { width: 1, height: 24, backgroundColor: '#EDF2F7', marginHorizontal: 10 },
  searchButton: {
    backgroundColor: '#FFB81C', justifyContent: 'center', alignItems: 'center',
    flexDirection: 'row', padding: 12, borderRadius: 12,
  },
  searchButtonText: { color: '#000080', fontSize: 15, fontWeight: '900' },

  // Taxi search console fields
  taxiConsoleTitle: { fontSize: 13, fontWeight: '800', color: '#1A202C', marginBottom: 8, paddingHorizontal: 8 },
  taxiInputRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 6 },
  taxiIcon: { marginRight: 8 },
