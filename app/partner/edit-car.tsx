        ...
        if (id) {
            fetch(`${API_URL}/cars/${id}`)
                ...
                .then(data => {
                    ...
                    setStateLocation(data.stateLocation || '');
                    ...
                    if (data.images && data.images.length > 0) {
                        ...
                        setImages([data.previewImage]);
                    }

                    if (data.driverName) setDriverName(data.driverName);
                    if (data.driverEmail) setDriverEmail(data.driverEmail);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                driverEmail,
                driverPhone,
                driverPassword, // Only send if we want to change it (or ignore in backend if empty)
            ...
            if (response.ok) {
                Toast.show({ type: 'success', text1: 'Car Updated', text2: 'Your car has been successfully updated.' });
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Edit Premium Car</Text>
                <View style={{ width: 40 }} />
            </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
                ...
                >
                    <Text style={styles.submitBtnText}>{isSubmitting ? 'Updating...' : 'Save Changes'}</Text>
                </TouchableOpacity>
