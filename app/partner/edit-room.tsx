...
export default function EditRoomScreen() {
            ...
            fetch(`${API_URL}/rooms/${id}`)
                ...
                .then(data => {
                    ...
                    if (data.hotelAddress) {
                        const parts = data.hotelAddress.split(',');
                        if (parts.length >= 3) {
                            setCountry(parts.pop().trim());
                            setState(parts.pop().trim());
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                Toast.show({ type: 'success', text1: 'Room Updated', text2: 'Your room has been successfully updated.' });
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Edit Premium Room</Text>
                <View style={{ width: 40 }} />
            </View>
